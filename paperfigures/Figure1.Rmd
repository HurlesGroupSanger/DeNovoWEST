...
novel$gofsig[novel$denovoWEST_p_full != novel$enrich_all_p_ud] <- 'pGoF'
...
ggplot(novel,aes(x=missense_variant,y = lofcount)) +
  ...
  geom_label_repel(aes(label = symbol,color = gofsig),box.padding   = 0.25,point.padding = 0.5,size =2.75) +
