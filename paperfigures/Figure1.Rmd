...
res_mup$diag_group[res_mup$diag_group == "novel" & res_mup$denovoWEST_p>0.025] <- "none"
res_mup <- res_mup[!is.na(res_mup$denovoWEST_p),]
res_mup$lg10denovoWEST <- -log10(res_mup$denovoWEST_p)
...
n_mupit <- sum(res_mup$mup_pval_bonf<=0.025 & res_mup$denovoWEST_p>0.025 & !is.na(res_mup$mup_pval_bonf) & !is.na(res_mup$denovoWEST_p))
n_new <- sum(res_mup$mup_pval_bonf>0.025 & res_mup$denovoWEST_p<=0.025 & !is.na(res_mup$mup_pval_bonf) & !is.na(res_mup$denovoWEST_p))
n_both <- sum(res_mup$mup_pval_bonf<=0.025 & res_mup$denovoWEST_p<=0.025 & !is.na(res_mup$mup_pval_bonf) & !is.na(res_mup$denovoWEST_p))
