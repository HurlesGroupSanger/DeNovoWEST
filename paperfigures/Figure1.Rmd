...
#res_mup$mup_pval_bonf <- p.adjust(res_mup$mup_pval,method = "bonferroni",n=(ngenes*2))
...
sum(res_mup$mup_pval>th & res_mup$denovoWEST_p_full>th & !is.na(res_mup$mup_pval) & !is.na(res_mup$denovoWEST_p_full))
