...
#plot
bp <- barplot(obscounts$x/expcounts$x,ylim = c(0,60),names.arg = c("low","medium","high"),xlab = "Genes' likelihood of US abnormality",ylab = "PTV enrichment",col = traffic,border = NA,cex.axis = 1.3,cex.lab = 1.5,cex.names = 1.3)
