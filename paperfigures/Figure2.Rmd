...
par(mar=c(17,4,2,2)+0.1)
bp <- barplot(t(as.table(diag.enrich[,1:2])),beside = T,las = 3, col = myColors[c(1,4)],ylab = "Log10(Mean in Diagnostic group/Mean in non-DD genes)",ylim = c(min(diag.enrich),max(diag.enrich)),border = NA)
abline(h = 0,lty = 2)
